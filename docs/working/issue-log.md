...
- **Files changed:**
  ...
  - Tests: `tests/api/test_notes_bulk.py` (14), `tests/api/test_notes_review.py` (+7), `frontend/src/pages/__tests__/NotesReview.test.tsx` (8), `frontend/src/layouts/__tests__/AppLayout.badge.test.tsx` (2)
