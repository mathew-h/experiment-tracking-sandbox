-- ============================================================================
-- Delete SERUM_Catalyst -t timepoint experiments (149 experiment IDs)
--
...
--   5. The input list contained 160 lines / 149 unique IDs (11 duplicates,
--      e.g. SERUM_Catalyst_001a-t1 appeared in two blocks). Duplicates are
--      de-duplicated below via ON CONFLICT DO NOTHING.
--
-- WHAT IT DOES NOT DO
...
--   - Does not rewrite `base_experiment_id` on surviving siblings. That column is a
...
INSERT INTO doomed_ids (experiment_id) VALUES
    ('SERUM_Catalyst_001a-t1'),
    ('SERUM_Catalyst_001a-t20'),
    ('SERUM_Catalyst_001a-t3'),
    ('SERUM_Catalyst_001a-t7'),
    ('SERUM_Catalyst_001b-t1'),
    ('SERUM_Catalyst_001b-t20'),
    ('SERUM_Catalyst_001b-t3'),
    ('SERUM_Catalyst_001b-t7'),
    ('SERUM_Catalyst_001c-t1'),
    ('SERUM_Catalyst_001c-t20'),
    ('SERUM_Catalyst_001c-t3'),
    ('SERUM_Catalyst_001c-t7'),
    ('SERUM_Catalyst_002-t1'),
    ('SERUM_Catalyst_002-t20'),
    ('SERUM_Catalyst_002-t3'),
    ('SERUM_Catalyst_002-t7'),
    ('SERUM_Catalyst_002a-t3'),
    ('SERUM_Catalyst_002b-t3'),
    ('SERUM_Catalyst_002c-t3'),
    ('SERUM_Catalyst_003a-t1'),
    ('SERUM_Catalyst_003a-t20'),
    ('SERUM_Catalyst_003a-t3'),
    ('SERUM_Catalyst_003a-t7'),
    ('SERUM_Catalyst_003b-t1'),
    ('SERUM_Catalyst_003b-t20'),
    ('SERUM_Catalyst_003b-t3'),
    ('SERUM_Catalyst_003b-t7'),
    ('SERUM_Catalyst_003c-t1'),
    ('SERUM_Catalyst_003c-t20'),
    ('SERUM_Catalyst_003c-t3'),
    ('SERUM_Catalyst_003c-t7'),
    ('SERUM_Catalyst_004-t1'),
    ('SERUM_Catalyst_004-t20'),
    ('SERUM_Catalyst_004-t3'),
    ('SERUM_Catalyst_004-t7'),
    ('SERUM_Catalyst_004a-t20'),
    ('SERUM_Catalyst_004b-t20'),
    ('SERUM_Catalyst_004c-t20'),
    ('SERUM_Catalyst_005-t1'),
    ('SERUM_Catalyst_005a-t1'),
    ('SERUM_Catalyst_005a-t20'),
    ('SERUM_Catalyst_005a-t3'),
    ('SERUM_Catalyst_005a-t7'),
    ('SERUM_Catalyst_005b-t1'),
    ('SERUM_Catalyst_005b-t20'),
    ('SERUM_Catalyst_005b-t3'),
    ('SERUM_Catalyst_005b-t7'),
    ('SERUM_Catalyst_005c-t1'),
    ('SERUM_Catalyst_005c-t20'),
    ('SERUM_Catalyst_005c-t3'),
    ('SERUM_Catalyst_005c-t7'),
    ('SERUM_Catalyst_006-t1'),
    ('SERUM_Catalyst_006-t20'),
    ('SERUM_Catalyst_006-t3'),
    ('SERUM_Catalyst_006-t7'),
    ('SERUM_Catalyst_007-t7'),
    ('SERUM_Catalyst_007a-t1'),
    ('SERUM_Catalyst_007a-t20'),
    ('SERUM_Catalyst_007a-t3'),
    ('SERUM_Catalyst_007a-t7'),
    ('SERUM_Catalyst_007b-t1'),
    ('SERUM_Catalyst_007b-t20'),
    ('SERUM_Catalyst_007b-t3'),
    ('SERUM_Catalyst_007b-t7'),
    ('SERUM_Catalyst_007c-t1'),
    ('SERUM_Catalyst_007c-t20'),
    ('SERUM_Catalyst_007c-t3'),
    ('SERUM_Catalyst_007c-t7'),
    ('SERUM_Catalyst_008-t1'),
    ('SERUM_Catalyst_008-t20'),
    ('SERUM_Catalyst_008-t3'),
    ('SERUM_Catalyst_008-t7'),
    ('SERUM_Catalyst_009a-t1'),
    ('SERUM_Catalyst_009a-t20'),
    ('SERUM_Catalyst_009a-t3'),
    ('SERUM_Catalyst_009a-t7'),
    ('SERUM_Catalyst_009b-t1'),
    ('SERUM_Catalyst_009b-t20'),
    ('SERUM_Catalyst_009b-t3'),
    ('SERUM_Catalyst_009b-t7'),
    ('SERUM_Catalyst_009c-t1'),
    ('SERUM_Catalyst_009c-t20'),
    ('SERUM_Catalyst_009c-t3'),
    ('SERUM_Catalyst_009c-t7'),
    ('SERUM_Catalyst_010-t1'),
    ('SERUM_Catalyst_010-t20'),
    ('SERUM_Catalyst_010-t3'),
    ('SERUM_Catalyst_010-t7'),
